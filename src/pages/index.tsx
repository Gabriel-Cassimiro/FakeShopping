          ...
          <div key={products.id} className="CONTAINER  p-4 lg:w-1/4">
            <div className="flex flex-col p-8 bg-white border-2 border-gray rounded-lg shadow-2xl">
              <Link href={`/product/${products.id}`}>
                <button className="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 mb-2">
                  <Image src={products.image} alt={products.title} height={400} width={400} title={products.category} className="object-contain" />
                </button>
              </Link>
